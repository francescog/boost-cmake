...
.. index:: ryppl_library_project
.. _ryppl_library_project_macro:

ryppl_library_project
---------------------

Define a ryppl library project.

.. cmake:: ryppl_library_project(libname[, ...])
...
.. subdirectory include/ryppl rather than the "global" ryppl
...
just libraries/executables created with :ref:`ryppl_add_library_macro`
and :ref:`ryppl_add_executable_macro`, except they are only built if
...
The Ryppl.Thread library uses the following invocation of the
`ryppl_library_project` macro, since it has both a compiled library
